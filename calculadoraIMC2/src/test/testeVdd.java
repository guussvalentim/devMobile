...
public class testeVdd {
	...
	public void testeAdultoBaixoPesoMuitoGraveLimiteMaximo() {
		Assert.assertEquals("Baixo peso muito grave", cal.calcularImc(2.1, 70.49, 65, "masculino"));
	...
	public void testeIdosoFemininoObesidadeIILimiteMaximo() {
		Assert.assertEquals("Obesidade grau II", cal.calcularImc(1.58, 104.6, 66, "feminino"));
	...
	public void testeIdosoMasculinoBaixoPeso() {
		Assert.assertEquals("Baixo peso", cal.calcularImc(1.64, 59, 66, "masculino"));
	...
	public void testeIdosoMasculinoObesidadeILimiteMaximo() {
		Assert.assertEquals("Obesidade grau I", cal.calcularImc(1.90, 126, 66, "masculino"));
	...
	public void testeIdosoMasculinoObesidadeIILimiteMaximo() {
		Assert.assertEquals("Obesidade grau II", cal.calcularImc(1.46, 85.25, 66, "masculino"));
